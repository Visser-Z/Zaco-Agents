...
| **Supplier Ref** | Written `producer*reference`, e.g. `20026*14700`. The reference half is sometimes the DN and often is not. |
...
| **Account sale** | A payment run the agent closes off, covering whatever sold in that period. Identified by an AccSale number, e.g. `PRE*BT*380101`. This is the workbook's **STM No** (column E) and is what the payment report pays against. |
...
"TSHWANE MARKET","Farmers Trust (Pre)"
"Delivery ID : ",1180699Z,"Supplier Ref : ",20026*14720,"Qty Sent : ",14,"Qty Amended To : ",
...
203001,20026*14701,PRE*BT*380102,2026-08-05,2295.00,352.17,52.83,2700.00,

,,,"Line No","Supplier Ref",Commodity,Delivered,Sold,"Sales Total"
,,,02,20026*14701,"NECTARINES OTHER CLASS 1 LARGE MULTI LAYER TRAYER 5.00 kg",43,10,2700.00
```
...
```
20026*14700 PRE*BT*380101 2026-07-01 R 2 700.00 R 352.17 R 52.83 R 2 295.00
20026*14705 & 14706 JOH*SUB*5640001/12026-07-13 R 6 000.00 R 782.61 ...
```
...
- The second market's AccSale carries an adjustment sequence (`/1`) and is printed
  **glued to the date** with no separating space: `5640001/12026-07-13`.
...
| From | To | Rule |
|---|---|---|
| `PRE*BT*380101` | `380101` | Digits of the last `*` segment, dropping any `/n` sequence. |
| `JOH*SUB*5640001/1` | `5640001` | Same rule. |
| `20026*14700` | DN `14700` | First number after the `*`. |
| `20026*14705 & 14706` | DN `14705` | Combined refs keep the first. |
| `20026*14700` | producer `20026` | The number before the `*`. |
...
- The reference is a number used as a **producer code** somewhere in this round.
  June carries both `14013*14710` and `20026*14013`, so 14013 is a producer and the
...
4. `JOH*SUB*5640001/12026-07-13` yields account sale `5640001` and date
   `2026-07-13`.
